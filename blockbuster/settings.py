...
SECRET_KEY = "django-insecure-5j=(vqr#_cu^oo)r568-+w!jsjd^2k^k17b)a1g*4k1o$%f*up"
...
CSRF_TRUSTED_ORIGINS = [
    'https://jessica-ruth-tugas.pbp.cs.ui.ac.id',
    'https://jessica-ruth-tugas.pbp.cs.ui.ac.id/',
    'https://jess-blockbuster.adaptable.app',
    'https://jess-blockbuster.adaptable.app/',
]